...
dependencies {
    implementation(project(":ui:audio-login"))
    implementation(project(":ui:playlist-login"))
    implementation(project(":ui:push-identity"))
    implementation(project(":ui:contact-identity"))
    implementation(project(":ui:login-identity"))
