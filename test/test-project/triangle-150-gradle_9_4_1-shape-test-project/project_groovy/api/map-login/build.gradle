...
dependencies {
    implementation(project(":data:alarm-login"))
    implementation(project(":data:note-login"))
    implementation(project(":data:document-login"))
    implementation(project(":data:timer-login"))
    implementation(project(":data:event-login"))
