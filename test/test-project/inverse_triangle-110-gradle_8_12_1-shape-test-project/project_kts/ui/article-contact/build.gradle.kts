...
dependencies {
    implementation(project(":presentation:user-contact"))
    implementation(project(":presentation:comment-contact"))
    implementation(project(":presentation:checkout-contact"))
    ...
    implementation(project(":presentation:feed-contact"))
