...
dependencies {
    implementation(project(":entity:calendar"))
    implementation(project(":entity:analytics"))
    implementation(project(":entity:report"))
    implementation(project(":entity:task"))
    implementation(project(":entity:metric"))
