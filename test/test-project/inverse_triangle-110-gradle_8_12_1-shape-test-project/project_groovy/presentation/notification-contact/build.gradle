...
dependencies {
    ...
    implementation(project(":api:photo"))
    implementation(project(":api:podcast"))
    implementation(project(":api:article"))
    implementation(project(":api:gallery"))
    implementation(project(":api:news"))
